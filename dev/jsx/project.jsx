            ...
            <div>
                ...
                <div className="projects">
                    <Project 
                        ...
                        <ul>
                            <li>Create pages and customise their appearance.</li>
                            <li>Import audio, video, images and text</li>
                            <li>Connect pages together, with support for decision automation.</li>
                        </ul>
                    </Project>
                    <Project 
                        title="InfinityDrive" 
                        ...
                        >
                        An incremental game made using the native HTML5 canvas element with <a href="http://ocanvas.org/" target="_blank">oCanvas</a>.
                    </Project>
                </div>
    ...
    render: function() {
        return (
            <div className="projectStyle" onClick={this.handleClick}>
                <ProjectTitle {...this.props}/>{/* ... operator splits an object into an array of its' elements */}
